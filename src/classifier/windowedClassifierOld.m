function [ predictedMap ] = windowedClassifierOld( hsi, mapTrain, alpha, sigma, nystroemFraction, sectionWidth, sectionHeight )
...
get_f_star = @(Y, X) sesuGraph_windowed(Y, X, alpha, sigma, nystroemFraction);
